...
from xnr.global_config import WX_S_DATE_NEW,WX_GROUP_MESSAGE_START_DATE,WX_S_DATE_ASSESSMENT,\
                    WX_GROUP_MESSAGE_START_DATE_ASSESSMENT                             
from xnr.parameter import MAX_VALUE, WEEK, DAY, MAX_SEARCH_SIZE
