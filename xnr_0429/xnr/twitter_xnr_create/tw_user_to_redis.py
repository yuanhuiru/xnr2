...
allDoc = es_xnr_2.search(index=tw_xnr_index_name, doc_type=tw_xnr_index_type, body=query)

task_redis_key = 'twitter_params'
...
for doc_info in allDoc['hits']['hits']:
    ...
    if doc_info_dict['_source']['tw_phone_account'] == '':
        params_dict['user_account'] = doc_info_dict['_source']['tw_mail_account']
    params_dict['user_account'] = doc_info_dict['_source']['tw_phone_account']
