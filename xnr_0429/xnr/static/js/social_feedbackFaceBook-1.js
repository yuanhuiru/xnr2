...
$('#container .type_page #myTabs a').on('click',function () {
    ...
    if (start&&end){
        var comURL='/facebook_xnr_operate/'+mmarrow+'/?xnr_user_no='+xnrUser+'&sort_item='+s+
...
$('#container .desc_index .demo-label input').on('click',function () {
    ...
    if (tp2=='show_friends'){tp1='update_time'}
    var s,d;
    if (tm!='mize'){
        s=getDaysBefore(tm);
        d=end_time;
            ...
            columns: [
                {
                    ...
                    formatter: function (value, row, index) {
                        ...
                        var str=
                            ...
                            '        <img src="'+img+'" alt="" class="com-head" style="width:50px;height:50px;">'+
                            '        <div class="com com-1">'+
        ...
        columns: [
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    var str=
                        ...
                        '        <img src="'+img+'" alt="" class="let-head" style="width:50px;height:50px;">'+
                        '        <div class="let let-1">'+
                        ...
                        '        <div class="clone-2">'+
                        '            <span href="###" class="clone-2-4" midurl="reply_private" onclick="comMent_feed(this,\'social_feedback\')">发送</span>'+
                        '        </div>'+
                        '    </div>'+
                        '</div>';
                    return str;
        ...
        columns: [
            {
                ...
                formatter: function (value, row, index) {
                    ...
                    var str=
                        ...
                        '        <img src="'+img+'" alt="" class="rep-head" style="width:50px;height:50px;">'+
                ...
                formatter: function (value, _row, index) {
                    ...
                    for (var i=0;i<_row.length;i++){
                        ...
                        str+=
                            ...
                            '   <img src="'+img+'" class="headImg" style="width:50px;height:50px;">' +
                            ...
                            '           <span class="friends">'+row.facebook_type+'</span></p>' +
                            '           <p style="display: inline-block;margin-left: 10px;"><span>好友数量：</span>' +
                            '           <span class="friends">'+row.friends+'</span></p>' +
                            '       </div>' +
                            '       <div class="infor-3">' +
...
function focusYES(data) {
    ...
    if (data[0]||data){
        ...
        if (focusYN==1){
            ...
            if (si=='timestamp'){si='update_time'};
            var ssr='/facebook_xnr_operate/show_friends/?xnr_user_no='+ID_Num+'&sort_item='+si+
                '&start_ts='+s+'&end_ts='+d;
            setTimeout(function () {
