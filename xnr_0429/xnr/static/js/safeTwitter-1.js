...
var historyTotal_url='/twitter_xnr_manage/show_history_count/?xnr_user_no='+ID_Num+'&type=&start_time='+getDaysBefore('7')+'&end_time='+end_time;
...
$('.choosetime .demo-label input').on('click',function () {
    ...
    if (_val=='mize'){
        ...
        public_ajax.call_request('get',historyTotal_url,historyTotal);
        //曲线图 1
        var safe_7day_url='/twitter_xnr_manage/lookup_xnr_assess_info/?xnr_user_no='+ID_Num+
            '&start_time='+startTime+'&end_time='+end_time+'&assess_type=safe';
        public_ajax.call_request('get',safe_7day_url,safe_7day);
        //曲线图 2
        var safe_url='/twitter_xnr_assessment/'+midURL+'/?xnr_user_no='+ID_Num+lastURL;
...
$('.sureTime').on('click',function () {
    ...
    if (s==''||d==''){
        ...
        public_ajax.call_request('get',safe_7day_url,safe_7day);
        //曲线图 2
        var safe_url='/twitter_xnr_assessment/safe_active/?xnr_user_no='+ID_Num+
            '&start_time='+start+'&end_time='+end+'&assess_type=safe';
        public_ajax.call_request('get',safe_url,safe);
    }
});
...
var scoreUrl='/twitter_xnr_assessment/safe_mark/?xnr_user_no='+ID_Num;
public_ajax.call_request('get',scoreUrl,score);
function score(data) {
    $('.title .tit-2 .score').text(data);
}
var defaultUrl='/twitter_xnr_assessment/safe_active/?xnr_user_no='+ID_Num+
    '&start_time='+getDaysBefore('7')+'&end_time='+end_time+'&assess_type=safe';
...
$('.pc-4 input').on('click',function () {
    ...
    var the_url='';
    if (t=='area'){
        the_url='/twitter_xnr_assessment/safe_tweets_topic/?xnr_user_no='+ID_Num+'&topic='+the+'&sort_item='+
            theSort+'&start_time='+t1+'&end_time='+t2;
    }else {
        the_url='/twitter_xnr_assessment/follow_group_tweets/?xnr_user_no='+ID_Num+'&domain='+the+'&sort_item='+
            theSort+'&start_time='+t1+'&end_time='+t2;
    }
