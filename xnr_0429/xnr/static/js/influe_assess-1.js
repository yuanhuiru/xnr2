...
var historyTotal_url='/weibo_xnr_manage/show_history_count/?xnr_user_no='+ID_Num+'&type=&start_time='+getDaysBefore('7')+'&end_time='+end_time;
...
public_ajax.call_request('get',influe_7day_url,influe_7day);
// var myChart7 = echarts.init(document.getElementById('near_7_day'),'dark');
function influe_7day(data) {
    $('#near_7_day p').show();    
    var nearTime=[],nearData=[];
    if (data.length==0){
        $('#near_7_day p').slideUp(700);
        //$('#near_7_day').append('<h2 style="width:100%;text-align:center;">趋势图暂无数据</h2>');
