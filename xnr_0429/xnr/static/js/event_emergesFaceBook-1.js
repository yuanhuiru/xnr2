...
var weiboUrl='/facebook_xnr_warning/show_event_warming/?xnr_user_no='+ID_Num+'&start_time='+todayTimetamp()+'&end_time='+time2;
        ...
        if(dataArray==''){
            ...
            {                                                          //循环打印数组值
                ...
                html_c =
                    ...
                    '                    <p style="font-size: 16px;color:#01b4ff;"><i class="icon icon-bookmark"></i> 相关典型帖子</p>'+
                    '                    <div class="mainWeibo">'+
