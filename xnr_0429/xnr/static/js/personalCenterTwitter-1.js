var has_url = '/twitter_xnr_manage/show_completed_twxnr/?account_no='+admin;
var notHao_url = '/twitter_xnr_manage/show_uncompleted_twxnr/?account_no='+admin;
...
//今日提醒
function alarm(id) {
    var clock_url = '/twitter_xnr_manage/xnr_today_remind/?xnr_user_no='+id;
...
function sureDelXnr() {
    var del_url = '/twitter_xnr_manage/delete_tw_xnr/?xnr_user_no='+delID;
    public_ajax.call_request('GET',del_url,success_fail);
}
//继续创建未完成的虚拟人
function go_on(id,flag,taskID) {
    localStorage.setItem('go_mod_user',id);
    window.open('/registered/virtualCreated/?continueUser='+flag+'&flag=5&taskID='+taskID);
