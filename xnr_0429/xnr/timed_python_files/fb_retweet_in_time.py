...
def retweet_operate_timing():
    ...
    results = es_xnr.search(index=fb_xnr_retweet_timing_list_index_name,doc_type=\
                    fb_xnr_retweet_timing_list_index_type,body=query_body)['hits']['hits']
    ...
    if results:
        for result in results:
            ...
            if timestamp_set <= int(time.time()):
                ...
                mark = fb_retweet(account_name, password, r_fid, uid, text, tweet_type, xnr_user_no)
                print 'mark::',mark
                if mark:
                 ...
                 #        fb_xnr_retweet_timing_list_index_type,id=task_id)['_source']
                    ...
                    es_xnr.update(index=fb_xnr_retweet_timing_list_index_name,doc_type=\
                        fb_xnr_retweet_timing_list_index_type,id=task_id,body={'doc':item_exist})
