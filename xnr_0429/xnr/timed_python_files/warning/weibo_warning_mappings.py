...
def weibo_event_warning_mappings(index_name):
	index_info = {
		'settings':{
			'number_of_replicas':0,
			'number_of_shards':5
...
def weibo_speech_warning_mappings(index_name):
	index_info = {
		'settings':{
			'number_of_replicas':0,
			'number_of_shards':5,
...
def weibo_timing_warning_mappings(index_name,date_result):
	index_info = {
		'settings':{
			'number_of_replicas':0,
			'number_of_shards':5
...
if __name__ == '__main__':	
	index_name = ''
	weibo_user_warning_mappings(index_name)
	weibo_event_warning_mappings(index_name)
	weibo_speech_warning_mappings(index_name)
	...
	weibo_timing_warning_mappings(index_name,date_result)
