...
from global_utils import    facebook_history_feedback_like_index_name,facebook_feedback_like_index_type,\
                            facebook_history_feedback_retweet_index_name,facebook_feedback_retweet_index_type,\
                            facebook_history_feedback_at_index_name,facebook_feedback_at_index_type,\
                            facebook_history_feedback_comment_index_name,facebook_feedback_comment_index_type,\
                            facebook_history_feedback_private_index_name,facebook_feedback_private_index_type,\
                            facebook_history_feedback_friends_index_name,facebook_feedback_friends_index_type
...
# 点赞
def facebook_history_feedback_like_mappings(index_name, index_type):
    index_info = {
        'settings': {
...
# 分享
def facebook_history_feedback_retweet_mappings(index_name, index_type):
    index_info = {
        'settings': {
            'number_of_replicas': 0,
            'number_of_shards': 5
...
# 评论
def facebook_history_feedback_comment_mappings(index_name, index_type):
    index_info = {
        'settings': {
            'number_of_replicas': 0,
            'number_of_shards': 5
...
# 私信
def facebook_history_feedback_private_mappings(index_name, index_type):
    index_info = {
        'settings': {
            'number_of_replicas': 0,
            'number_of_shards': 5
