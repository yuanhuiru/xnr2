...
#waring
from global_utils import weibo_user_warning_index_name_pre,weibo_user_warning_index_type,facebook_user_warning_index_name_pre,twitter_user_warning_index_name_pre,\
