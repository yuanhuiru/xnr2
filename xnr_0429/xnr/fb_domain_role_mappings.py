...
def example_model_mappings():
    ...
    if not es.indices.exists(index=fb_example_model_index_name):
        print es.indices.create(index=fb_example_model_index_name,body=index_info,ignore=400)
