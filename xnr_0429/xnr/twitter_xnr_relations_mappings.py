...
def twitter_xnr_relations_mappings():
    index_info = {
        'settings':{
    ...
    exist_indice=es.indices.exists(index=twitter_xnr_relations_index_name)
    if not exist_indice:
        print es.indices.create(index=twitter_xnr_relations_index_name,body=index_info,ignore=400)

def delete_mappings():
    print es.indices.delete(index=twitter_xnr_relations_index_name, ignore=400)
...
if __name__=='__main__':
    twitter_xnr_relations_mappings()
    # delete_mappings()
