...
from  mappings_V_social_sensing import mappings_sensing_task
...
DAY = 24*3600
index_sensing_task = "social_v_sensing_task"
type_sensing_task = "social_v_sensing"
index_manage_social_task = "manage_v_sensing_task"
task_doc_type = "task"
forward_n = 24
initial_count = 12
...
#         comment_count = 0
    ...
    for mid in mid_list:
        ...
        if count % 500 == 0:
            es_xnr.bulk(bulk_action, index="social_v_sensing_text", doc_type="text", timeout=600)
            bulk_action = []
