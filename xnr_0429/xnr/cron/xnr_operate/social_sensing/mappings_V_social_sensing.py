...
def mappings_sensing_task(task_name):
    ...
    print es.indices.create(index="social_v_sensing_task", body=index_info, ignore=400)
...
def manage_sensing_task():
    ...
    print es.indices.create(index="manage_v_sensing_task", body=index_info, ignore=400)
...
if __name__ == "__main__":
    manage_sensing_task()
    mappings_sensing_task("social_v_sensing")
    #index_name = 'social_sensing_text_' + ts2datetime(time.time())
    index_name = 'social_v_sensing_text'
