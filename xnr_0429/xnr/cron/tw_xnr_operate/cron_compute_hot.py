...
from global_utils import tw_recommend_subopinion_keywords_task_queue_name as keyword_task_queue_name
from global_utils import R_RECOMMEND_SUBOPINION_KEYWORD_TASK as r
from global_utils import tw_hot_keyword_task_index_name,tw_hot_keyword_task_index_type,\
                        tw_recommend_subopinion_keywords_task_queue_name,\
                        tw_xnr_fans_followers_index_name,tw_xnr_fans_followers_index_type
from global_config import S_TYPE,S_DATE_FB
from time_utils import tw_get_flow_text_index_list,datetime2ts
...
def compute_recommend_subopnion(task_detail):
    ...
    print '开始子观点计算......'
    if tw_list:
        opinion_name,word_result,text_list = opinion_main(tw_list,k_cluster=5)
