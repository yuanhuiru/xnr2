...
#nr_map_index_name='xnr_map_relationship'
...
active_social_index_type = 'recommend'
...
twitter_history_feedback_comment_index_name = 'twitter_history_feedback_comment'
...
twitter_history_feedback_retweet_index_name = 'twitter_history_feedback_retweet'
...
twitter_history_feedback_private_index_name = 'twitter_history_feedback_private'
...
twitter_history_feedback_at_index_name = 'twitter_history_feedback_at'
...
twitter_history_feedback_like_index_name = 'twitter_history_feedback_like'
...
twitter_history_feedback_fans_index_name = 'twitter_history_feedback_fans'
...
new_history_tw_xnr_flow_text_index_name = 'new_history_tw_xnr_flow_text'
...
R_WEIBO_WARNING = _default_redis_v2(host=REDIS_HOST_46, port=REDIS_PORT_46, db=1)
weibo_user_warning_task_queue_name = 'weibo_user_warning_task'
weibo_speech_warning_task_queue_name = 'weibo_speech_warning_task'
...
R_CLUSTER_FLOW2 = redis.StrictRedis(host=REDIS_HOST_37, port=REDIS_PORT_37, db=2)

# sensitive user
#R_CLUSTER_FLOW3 = redis.StrictRedis(host=REDIS_CLUSTER_HOST_FLOW3, port=REDIS_CLUSTER_PORT_FLOW3)
R_CLUSTER_FLOW3 = redis.StrictRedis(host=REDIS_HOST_37, port=REDIS_PORT_37, db=3)
...
R_UNAME2ID_FT = redis.StrictRedis(host=REDIS_HOST_37, port=REDIS_PORT_37)
fb_uname2id = 'fb_user_id_name_mapping'
tw_uname2id = 'tw_user_id_name_mapping'

# r_retweet 转发网络
redis_host_list = [1,2]
R_retweet = _default_redis_v2(host=REDIS_HOST_37, port=REDIS_PORT_37, db=2)

fb_retweet_1 = _default_redis_v2(host=REDIS_HOST_37, port=REDIS_PORT_37, db=3)
fb_retweet_2 = _default_redis_v2(host=REDIS_HOST_37, port=REDIS_PORT_37, db=4)

tw_retweet_1 = _default_redis_v2(host=REDIS_HOST_37, port=REDIS_PORT_37, db=5)
tw_retweet_2 = _default_redis_v2(host=REDIS_HOST_37, port=REDIS_PORT_37, db=6)
