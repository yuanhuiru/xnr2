...
#WX虚拟人
def get_wx_xnr_list(account_name):
    query_body={
        'query':{
        	'filtered':{
        		'filter':{
    ...
    try:
        user_result=es.search(index=wx_xnr_index_name,doc_type=wx_xnr_index_type,body=query_body)['hits']['hits']
        xnr_user_no_list=[]
        for item in user_result:
            xnr_user_no_list.append(item['_source']['xnr_user_no'])
    except:
...
#fb虚拟人
def get_fb_xnr_list(user_account,status_start,status_end):
    query_body={
        'query':{
        	'filtered':{
        		'filter':{
...
def show_all_users_account():
    ...
    for account_name in account_list:
        ...
        account_dict['uncomplete_xnr_facebook']=get_fb_xnr_list(account_name,status_zero,status_second)
        account_dict['uncomplete_xnr_twitter']=get_tw_xnr_list(account_name,status_zero,status_second)
        #已完成虚拟人
        ...
        account_dict['complete_xnr_weixin']=get_wx_xnr_list(account_name)
        account_dict['complete_xnr_facebook']=get_fb_xnr_list(account_name,status_second,status_three)
        account_dict['complete_xnr_twitter']=get_tw_xnr_list(account_name,status_second,status_three)
...
def show_users_account(main_user):
    ...
    weixin_dict['complete_xnr_list']=get_wx_xnr_list(main_user)
    ...
    facebook_dict['complete_xnr_list']=get_fb_xnr_list(main_user,status_second,status_three)
    facebook_dict['uncomplete_xnr_list']=get_fb_xnr_list(main_user,status_zero,status_second)
    account_list.append(facebook_dict)

    #twitter
    twitter_dict=dict()
    twitter_dict['platform_name']='twitter'
    twitter_dict['complete_xnr_list']=get_tw_xnr_list(main_user,status_second,status_three)
    twitter_dict['uncomplete_xnr_list']=get_tw_xnr_list(main_user,status_zero,status_second)
